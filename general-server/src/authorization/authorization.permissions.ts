...
export const SEEDED_PERMISSIONS: readonly SeedPermissionDefinition[] = [
  ...
  {
    code: ADMIN_CONSOLE_PERMISSION_CODES.globalConfigCreate,
    appCode: ADMIN_CONSOLE_APP_CODE,
    resourceType: 'button',
    resourceCode: 'global-config',
    action: 'create',
    name: '新增全局配置',
    description: '允许在管理后台新增全局配置。',
  },
  {
    code: ADMIN_CONSOLE_PERMISSION_CODES.globalConfigUpdate,
    appCode: ADMIN_CONSOLE_APP_CODE,
    resourceType: 'button',
    resourceCode: 'global-config',
    action: 'update',
    name: '修改全局配置',
    description: '允许在管理后台修改全局配置。',
  },
  {
    code: ADMIN_CONSOLE_PERMISSION_CODES.globalConfigDelete,
    appCode: ADMIN_CONSOLE_APP_CODE,
    resourceType: 'button',
    resourceCode: 'global-config',
    action: 'delete',
    name: '删除全局配置',
    description: '允许在管理后台删除全局配置。',
  },
  {
  ...
  {
    code: ADMIN_CONSOLE_PERMISSION_CODES.globalConfigApiRead,
    appCode: ADMIN_CONSOLE_APP_CODE,
    resourceType: 'api',
    resourceCode: 'global-config',
    action: 'read',
    name: '全局配置接口查看',
    description: '允许调用全局配置查询接口。',
  },
  {
    code: ADMIN_CONSOLE_PERMISSION_CODES.globalConfigApiCreate,
    appCode: ADMIN_CONSOLE_APP_CODE,
    resourceType: 'api',
    resourceCode: 'global-config',
    action: 'create',
    name: '全局配置接口新增',
    description: '允许调用全局配置新增接口。',
  },
  {
    code: ADMIN_CONSOLE_PERMISSION_CODES.globalConfigApiUpdate,
    appCode: ADMIN_CONSOLE_APP_CODE,
    resourceType: 'api',
    resourceCode: 'global-config',
    action: 'update',
    name: '全局配置接口修改',
    description: '允许调用全局配置修改接口。',
  },
  {
    code: ADMIN_CONSOLE_PERMISSION_CODES.globalConfigApiDelete,
    appCode: ADMIN_CONSOLE_APP_CODE,
    resourceType: 'api',
    resourceCode: 'global-config',
    action: 'delete',
    name: '全局配置接口删除',
    description: '允许调用全局配置删除接口。',
  },
] as const;
...
export const SEEDED_ROLE_PERMISSION_CODES: Readonly<Record<string, readonly string[]>> = {
  ...
  'admin-console.viewer': [
    ...
    ADMIN_CONSOLE_PERMISSION_CODES.globalConfigMenuView,
  ...
  'admin-console.editor': [
    ...
    ADMIN_CONSOLE_PERMISSION_CODES.globalConfigCreate,
    ADMIN_CONSOLE_PERMISSION_CODES.globalConfigUpdate,
    ADMIN_CONSOLE_PERMISSION_CODES.globalConfigDelete,
