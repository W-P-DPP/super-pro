...
import globalConfigRouter, { globalConfigPublicRouter } from './globalConfig/global-config.router.ts';
...
import todoRouter, { todoPublicRouter } from './todo/todo.router.ts';
...
router.use('/global-config', globalConfigPublicRouter);
...
router.use('/todo', todoPublicRouter);
