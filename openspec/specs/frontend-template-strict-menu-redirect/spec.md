...
When the frontend template opens the login page for a strict menu card click, it SHALL include a `redirect` query parameter whose value is the clicked card's original target address.
