...
export const ADMIN_CONSOLE_PERMISSION_CODES = {
  ...
  todosMenuView: 'admin-console.menu.todos.view',
  ...
  todoCreate: 'admin-console.button.todos.create',
  todoUpdate: 'admin-console.button.todos.update',
  todoDelete: 'admin-console.button.todos.delete',
  ...
  todosApiRead: 'admin-console.api.todos.read',
  todosApiCreate: 'admin-console.api.todos.create',
  todosApiUpdate: 'admin-console.api.todos.update',
  todosApiDelete: 'admin-console.api.todos.delete',
