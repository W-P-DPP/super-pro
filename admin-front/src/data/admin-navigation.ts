...
export const adminModules: AdminModule[] = [
  ...
  buildModule({
    ...
    description: '\u6309\u9879\u76ee\u7ef4\u5ea6\u7ef4\u62a4\u5168\u5c40\u914d\u7f6e\u9879\uff0c\u652f\u6301\u6587\u672c\u3001\u6570\u5b57\u548c\u5e03\u5c14\u7c7b\u578b\u7684 CRUD \u7ba1\u7406\u3002',
    icon: Settings2Icon,
    primaryAction: '\u65b0\u589e\u914d\u7f6e',
    secondaryAction: '\u67e5\u770b\u7c7b\u578b\u89c4\u5219',
    metrics: [
      { label: '\u63a5\u5165\u9879\u76ee', value: '12', hint: '\u6309\u9879\u76ee\u5207\u6362\u914d\u7f6e\u89c6\u56fe' },
      { label: '\u914d\u7f6e\u7c7b\u578b', value: '3', hint: '\u6587\u672c\u3001\u6570\u5b57\u3001\u5e03\u5c14' },
      { label: '\u5f85\u7ef4\u62a4\u9879', value: '18', hint: '\u53ef\u627f\u63a5\u771f\u5b9e\u5206\u9875\u548c\u7b5b\u9009' },
      { label: '\u6743\u9650\u8fb9\u754c', value: '8', hint: '\u542b\u83dc\u5355\u3001\u6309\u94ae\u548c API \u64cd\u4f5c' },
    ],
    highlights: [
      { title: '\u9879\u76ee\u7ef4\u5ea6', detail: '\u5de6\u4fa7\u9879\u76ee\u5217\u8868\u9a71\u52a8\u53f3\u4fa7\u914d\u7f6e\u8868\u683c\uff0c\u907f\u514d\u8de8\u9879\u76ee\u6df7\u7f16\u3002', status: '\u5fc5\u5907' },
      { title: '\u7c7b\u578b\u6821\u9a8c', detail: '\u65b0\u589e\u548c\u7f16\u8f91\u65f6\u6309\u914d\u7f6e\u7c7b\u578b\u6821\u9a8c\u53d6\u503c\uff0c\u907f\u514d\u810f\u6570\u636e\u5165\u5e93\u3002', status: '\u5fc5\u5907' },
      { title: '\u6743\u9650\u95ed\u73af', detail: '\u83dc\u5355\u53ef\u89c1\u3001\u64cd\u4f5c\u6309\u94ae\u548c\u53d7\u4fdd\u62a4 API \u540c\u6b65\u6536\u53e3\u3002', status: '\u5df2\u8bbe\u8ba1' },
    ],
    table: {
      title: '\u914d\u7f6e\u9879\u793a\u4f8b',
      description: '\u4f5c\u4e3a\u5168\u5c40\u914d\u7f6e\u9875\u7684\u9759\u6001\u515c\u5e95\u4fe1\u606f\uff0c\u540e\u7eed\u53ef\u66ff\u6362\u4e3a\u771f\u5b9e\u5217\u8868\u548c\u5f39\u7a97\u8868\u5355\u3002',
      columns: ['\u6240\u5c5e\u9879\u76ee', '\u914d\u7f6e\u952e', '\u7c7b\u578b', '\u503c'],
      rows: [
        ['admin-console', 'site.title', '\u6587\u672c', 'Superpowers BMS'],
        ['admin-console', 'dashboard.refreshInterval', '\u6570\u5b57', '30'],
        ['finance-core', 'invoice.autoApprove', '\u5e03\u5c14', 'false'],
        ['zwpsite', 'landing.heroTitle', '\u6587\u672c', '\u667a\u80fd\u95e8\u6237'],
      ],
    },
  }),
  buildModule({
